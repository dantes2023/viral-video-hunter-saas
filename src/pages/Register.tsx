...
const Register = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="flex justify-center">
            <Link to="/" className="flex items-center">
              <Video className="h-12 w-12 text-brand-500" />
      ...
      <div className="bg-white dark:bg-gray-800 py-4 text-center text-sm text-gray-500 dark:text-gray-400">
        <p>&copy; 2025 CaçaViral. Todos os direitos reservados.</p>
      </div>
    </div>
  );
};
